...
public class DigesterRuleParser extends RuleSetBase {
    ...
    private final static int MAX_CIRCULAR_TIMES = 6; //嵌套层数, 最大16层
    
    private static int circularTimes = 0; //嵌套层数, 最大16层
    ...
    protected class PatternStack extends ArrayStack {
        /**
		 * DigesterRuleParser.java is 
		 */
		private static final long serialVersionUID = 5908370219728888182L;
    ...
    private class IncludeRule extends Rule {
        ...
        private void includeXMLRules(String fileName)
            ...
            if (includedFiles.add(fileName) == false) {
            	circularTimes ++;
            	if (circularTimes > MAX_CIRCULAR_TIMES) {
//            		circularTimes = 0;
            		return;
            	}

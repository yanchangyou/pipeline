package org.software.sphere.society.platform.pipeline.test;
...
import org.software.sphere.society.platform.pipeline.lang.code.RootNode;
...
public class Test implements Runnable, Logable {
	...
	public void run() {
		...
		try {
			root = RootNode.load(PIPELINE_FILE_PATH);
...
//			org.software.sphere.society.platform.pipeline.lang.core.datanode.datanode0X.String portString = new org.software.sphere.society.platform.pipeline.lang.core.datanode.datanode0X.String(port);
//			root.addNextNode(new org.software.sphere.society.platform.pipeline.lang.core.datanode.datanode0X.String("port"), portString);
			root.justDoIt(null);

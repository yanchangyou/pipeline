...
public class Manage extends ActionNode {

	public void justDoIt(Sessionable session) {
...
//		Manage thread;
//
//		public ServiceThread(Socket socket, Manage thread) {
//			this.socket = socket;
//			this.thread = thread;
//		}
//
//		public void run() {
//			log.info("[" + Manage.this.getName() + "]服务开始");
//			thread.service(socket);
//			log.info("[" + Manage.this.getName() + "]服务结束");
//		}
//	}
//

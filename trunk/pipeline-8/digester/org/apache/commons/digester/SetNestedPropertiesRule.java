...
public class SetNestedPropertiesRule extends Rule {
    ...
    private class AnyChildRule extends Rule {
		...
		public String getCurrChildElementName() {
			return currChildElementName;
		}

		public void setCurrChildElementName(String currChildElementName) {
			this.currChildElementName = currChildElementName;
		}

		public String getCurrChildNamespaceURI() {
			return currChildNamespaceURI;
		}

		public void setCurrChildNamespaceURI(String currChildNamespaceURI) {
			this.currChildNamespaceURI = currChildNamespaceURI;
		}
    }
}
